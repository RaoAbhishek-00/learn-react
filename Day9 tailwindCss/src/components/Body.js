  ...
  return (
    <div className="body">
      <div className="  py-2">
        ...
        <button className=" outline outline-1  items-center justify-center rounded-md p-2 bg-gray-300 text-gray-800 hover:bg-gray-700  " onClick={searchBtn}>search</button>
      </div>

      <div className="py-2">
        <button className=" outline outline-1  items-center justify-center rounded-md p-2 mx-2 bg-gray-300 text-gray-800 hover:bg-gray-700  " onClick={filterBtn}>
